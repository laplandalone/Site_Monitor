...
public class ContactActivity extends BaseActivity
{
	...
	private UserContactT contactT = new UserContactT();
	@Override
	...
	public void submit(View v)
	{
		...
		if("".equals(userNameT))
		{
			HealthUtil.infoAlert(ContactActivity.this, "真实姓名为空.");
			return;
		}else if(userNameT.length()>6)
		{
			HealthUtil.infoAlert(ContactActivity.this, "真实姓名长度无效.");
			return;
		}
		if (!HealthUtil.isMobileNum(phoneNum))
		{
			HealthUtil.infoAlert(ContactActivity.this, "手机号码为空或格式错误.");
			return;
		} else if (!"YES".equals(idCheckRst))
		{
			HealthUtil.infoAlert(ContactActivity.this, idCheckRst);
			return;
		}

		if (radioButton == null)
		{
			HealthUtil.infoAlert(ContactActivity.this, "用户性别为空.");
			return;
		} else
		{
		...
		dialog.show();
		RequestParams param = webInterface.addUserContact(userStr);
	...
	class MineRequestCallBack extends RequestCallBack<String>
	{
		...
		public void onFailure(HttpException error, String msg)
		{
			...
			HealthUtil.infoAlert(ContactActivity.this, "信息加载失败，请检查网络后重试");
		}
