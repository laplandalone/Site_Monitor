...
public class CheckRstListActivity extends BaseActivity  implements OnItemClickListener
{
	...
	{
		Intent intent = new Intent(CheckRstListActivity.this, MainPageActivity.class);
	...
	class MineRequestCallBack extends RequestCallBack<String>
	{
		...
		public void onFailure(HttpException error, String msg)
		{
			...
			HealthUtil.infoAlert(CheckRstListActivity.this, "信息加载失败，请检查网络后重试");
		}
	...
	private void returnMsg(String json, int code)
	{
	   ...
	   rstTs  = gson.fromJson(jsonArray, new TypeToken<List<CheckRstT>>()
		...
		{
			CheckRstListAdapter adapter = new CheckRstListAdapter(CheckRstListActivity.this, rstTs);
