...
public class CardActivity extends BaseActivity implements OnItemClickListener {
	...
	protected void initValue() {
		...
		List<Car> cars = new Gson().fromJson(carStr,
	...
	public void submit(View v) {
		...
		RequestParams param = webInterface.record("0", cityId, oriLineId,
				realLineId, carNo, stopId, stopName);
	...
	private void invokeWebServer(RequestParams param, int responseCode) {
		...
		httpHandler = mHttpUtils.send(HttpMethod.POST, Constant.URL_record,
